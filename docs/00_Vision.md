...
- Collect relevant consumer and market signals from approved sources.
...
The early product should demonstrate that:

- Users can obtain an initial insight faster than with a manual research process.
...
- Which industries, countries, and languages should the first release support?
